...
let BattleStatuses = {
	choicelock: {
		...
		onBeforeMove: function (pokemon, target, move) {
			if (!(pokemon.getItem().isChoice || (pokemon.volatiles['beastbootleg'] && (pokemon.volatiles['beastbootleg'].items[0].isChoice || pokemon.volatiles['beastbootleg'].items[1].isChoice))) || !pokemon.hasMove(this.effectData.move)) {
