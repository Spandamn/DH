...
exports.Formats = [
  	...
  	},
	{
		...
		banlist: ['Unreleased'],//, 'Dialcatty', 'Kars', 'Dittsey', 'Diceus', 'Peridot-Mega', 'Kyzor', 'Gonzap', 'Harem', 'Cinshado', 'Enteon', 'Mega Lucashadow', 'Kahoot', 'Taiwan', 'Passcraft', 'Dad', 'Enteon', 'Entir', 'Ultra Necrynx', 'Ultra Necrozerain', 'Shenala', 'Mega Xurkizard Y', 'Mega Archedactyl', 'Miminja', 'Mega Toxicario', 'Mega Lucasol L', 'Mega Alakario L', 'Mega Khangorus-Khan', 'Mega Kasukabe', 'Mega Absoko', 'Mega Kartaria', 'Dio', 'Mendoza', 'Deoxurk-Outlet', 'Omneus','Muddy Seed'],
