...
evgutter: function (target, room, user) {
	...
	sylvespeed: function (target, room, user) {
		...
		Object.values(feDex).forEach(mon => {
			...
			if (mon.species === "Chansey" || mon.species === "Jirachi" || mon.species === "Hawlucha" || mon.species === "Kartana" || mon.species === "Magearna" || mon.species === "ScizorMega" || mon.species === "TapuKoko" || mon.species === "AshGreninja" || mon.species === "LandorusTherian" || mon.species === "TapuLele" || mon.species === "TornadusIncarnate" || mon.species === "Greninja" || mon.species === "Heatran" || mon.species === "Keldeo" || mon.species === "PinsirMega" || mon.species === "Serperior" || mon.species === "TapuBulu" || mon.species === "Toxapex" || mon.species === "AerodactylMega" || mon.species === "Articuno" || mon.species === "CharizardMegaX" || mon.species === "Emolga" || mon.species === "Ferrothorn" || mon.species === "Infernape" || mon.species === "Klinklang" || mon.species === "MawileMega" || mon.species === "MedichamMega" || mon.species === "Zapdos" || mon.species === "AlakazamMega" || mon.species === "Celesteela" || mon.species === "Flygon" || mon.species === "GalladeMega" || mon.species === "Goodra" || mon.species === "Nihilego" || mon.species === "Parasect" || mon.species === "Raichu(Kanto)" || mon.species === "Togedemaru" || mon.species === "Celebi" || mon.species === "LatiosMega" || mon.species === "MeloettaPirouette" || mon.species === "Metagross" || mon.species === "Palossand" || mon.species === "Slaking" || mon.species === "TapuFini" || mon.species === "Wishiwashi" || mon.species === "Xurkitree" || mon.species === "Azumarill" || mon.species === "Garchomp" || mon.species === "LatiasMega" || mon.species === "Manaphy" || mon.species === "Mimikyu" || mon.species === "Scizor" || mon.species === "Terrakion" || mon.species === "VenusaurMega" || mon.species === "Latios" || mon.species === "Staraptor" || mon.species === "Victini" || mon.species === "GarchompMega" || mon.species === "Meloetta" || mon.species === "Skarmory" || mon.species === "Shuckle") {
			buf += `${speedtierplus}: Fast+ ${mon.species}<br>${speedtier}: Fast ${mon.species}<br>${speedtierzero}: Bulky ${mon.species}<br>`;
			}
			});
		this.sendReplyBox(`${buf}</div>`);
